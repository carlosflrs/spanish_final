function main() {
    file = ['Hubo un tiempo en que yo pensaba mucho en los axolotl.',
'Iba a verlos al acuario del Jardín des Plantes y me quedaba horas mirándolos, observando su inmovilidad, sus oscuros movimientos.',
...
'Bajé por el bulevar de Port Royal, tomé St.',
...
'Dejé mi bicicleta contra las rejas y fui a ver los tulipanes.',
'Los leones estaban feos y tristes y mi pantera dormía.',
'Opté por los acuarios, soslayé peces vulgares hasta dar inesperadamente con los axolotl.',
'Me quedé una hora mirándolos, y salí incapaz de otra cosa.',
'En la biblioteca Saint-Geneviève consulté un diccionario y supe que los axolotl son formas larvales, provistas de branquias, de una especie de batracios del género amblistoma.',
'Que eran mexicanos lo sabía ya por ellos mismos, por sus pequeños rostros rosados aztecas y el cartel en lo alto del acuario.',
'Leí que se han encontrado ejemplares en África capaces de vivir en tierra durante los períodos de sequía, y que continúan su vida en el agua al llegar la estación de las lluvias.',
'Encontré su nombre español, ajolote, la mención de que son comestibles y que su aceite se usaba (se diría que no se usa más) como el de hígado de bacalao.',
'No quise consultar obras especializadas, pero volví al día siguiente al Jardin des Plantes.',
'Empecé a ir todas las mañanas, a veces de mañana y de tarde.',
'El guardián de los acuarios sonreía perplejo al recibir el billete.',
...
'Me había bastado detenerme aquella primera mañana ante el cristal donde unas burbujas corrían en el agua.',
...
'Y entonces descubrí sus ojos, su cara, dos orificios como cabezas de alfiler, enteramente de un oro transparente carentes de toda vida pero mirando, dejándose penetrar por mi mirada que parecía pasar a través del punto áureo y perderse en un diáfano misterio interior.',
'Un delgadísimo halo negro rodeaba el ojo y los inscribía en la carne rosa, en la piedra rosa de la cabeza vagamente triangular pero con lados curvos e irregulares, que le daban una total semejanza con una estatuilla corroída por el tiempo.',
...
'A ambos lados de la cabeza, donde hubieran debido estar las orejas, le crecían tres ramitas rojas como de coral, una excrescencia vegetal, las branquias supongo.',
'Y era lo único vivo en él, cada diez o quince segundos las ramitas se enderezaban rígidamente y volvían a bajarse.',
'A veces una pata se movía apenas, yo veía los diminutos dedos posándose con suavidad en el musgo.',
'Es que no nos gusta movernos mucho, y el acuario es tan mezquino; apenas avanzamos un poco nos damos con la cola o la cabeza de otro de nosotros; surgen dificultades, peleas, fatiga.',
...
'Después supe mejor, la contracción de las branquias, el tanteo de las finas patas en las piedras, la repentina natación (algunos de ellos nadan con la simple ondulación del cuerpo) me probó que eran capaz de evadirse de ese sopor mineral en el que pasaban horas enteras.',
'Sus ojos sobre todo me obsesionaban.',
'Al lado de ellos en los restantes acuarios, diversos peces me mostraban la simple estupidez de sus hermosos ojos semejantes a los nuestros.',
...
'Y sin embargo estaban cerca.',
'Lo supe antes de esto, antes de ser un axolotl.',
'Lo supe el día en que me acerqué a ellos por primera vez.',
...
'Sólo las manecitas.',
'.',
'Pero una lagartija tiene también manos así, y en nada se nos parece.',
...
'En ese instante yo sentía como un dolor sordo; tal vez me veían, captaban mi esfuerzo por penetrar en lo impenetrable de sus vidas.',
...
'Me sentía innoble frente a ellos, había una pureza tan espantosa en esos ojos transparentes.',
'Eran larvas, pero larva quiere decir máscara y también fantasma.',
'Detrás de esas caras aztecas inexpresivas y sin embargo de una crueldad implacable, ¿qué imagen esperaba su hora?',
'Les temía.',
'Creo que de no haber sentido la proximidad de otros visitantes y del guardián, no me hubiese atrevido a quedarme solo con ellos.',
...
'Llegué a ir todos los días, y de noche los imaginaba inmóviles en la oscuridad, adelantando lentamente una mano que de pronto encontraba la de otro.',
...
'Ellos y yo sabíamos.',
'Por eso no hubo nada de extraño en lo que ocurrió.',
'Mi cara estaba pegada al vidrio del acuario, mis ojos trataban una vez mas de penetrar el misterio de esos ojos de oro sin iris y sin pupila.',
'Veía de muy cerca la cara de una axolotl inmóvil junto al vidrio.',
...
'Afuera mi cara volvía a acercarse al vidrio, veía mi boca de labios apretados por el esfuerzo de comprender a los axolotl.',
'Yo era un axolotl y sabía ahora instantáneamente que ninguna comprensión era posible.',
'Él estaba fuera del acuario, su pensamiento era un pensamiento fuera del acuario.',
...
'Pero aquello cesó cuando una pata vino a rozarme la cara, cuando moviéndome apenas a un lado vi a un axolotl junto a mí que me miraba, y supe que también él sabía, sin comunicación posible pero tan claramente.',
...
'Él volvió muchas veces, pero viene menos ahora.',
'Pasa semanas sin asomarse.',
'Ayer lo vi, me miró largo rato y se fue bruscamente.',
...
'Pero los puentes están cortados entre él y yo porque lo que era su obsesión es ahora un axolotl, ajeno a su vida de hombre.',
...
'Me parece que de todo esto alcancé a comunicarle algo en los primeros días, cuando yo era todavía él.',
